...
단순한 기능 구현을 넘어 사용자 경험을 최우선으로 고려하며,  
디자인부터 마이크로 인터랙션, 렌더링 전략 개선과 Lighthouse 기반 성능 분석을 통해 사용자 불편을 빠르게 인지하고 해결해왔습니다.  

또한 **Spring Boot 기반 API 설계 및 데이터 흐름 구조를 고민하며**, 효율적인 데이터 처리와 안정적인 서비스 운영을 위한 서버 구조에 관심을 가지고 있습니다.  
클린 코드와 재사용 가능한 구조를 지향하며, 프론트엔드와 백엔드를 아우르는 시각으로 더 나은 사용자 경험을 만드는 개발자가 되고자 합니다 :)
